...
void FileOperations::SetDirectory(std::string const& path) {
	executionPath = path;
}

std::string FileOperations::GetDirectory() {
	return executionPath;
}

int FileOperations::SearchDirectory(std::vector<std::string>& refvecFiles, const std::string& refcstrRootDirectory, const std::set<std::string>& refcstrExtension, bool bSearchSubdirectories) {
